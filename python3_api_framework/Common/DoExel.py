...
if __name__ == '__main__':
  ...
  de = DoExcel(os.path.split(os.path.realpath(__file__))[0].replace('Common', 'TestDatas') + '/1.xlsx')
  all_case_datas = de.get_caseData_all()
  print(all_case_datas)
  de.Modify_init_data()
  de.save_excel(os.path.split(os.path.realpath(__file__))[0].replace('Common', 'TestDatas') + '/1.xlsx')